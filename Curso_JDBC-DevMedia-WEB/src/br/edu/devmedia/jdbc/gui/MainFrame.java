    ...
    private void initComponents() {
        ...
        //======== mainTabbedPane ========
        {
            ...
            //======== panelCadastro ========
            {
                ...
                panelCadastro.setBorder(new CompoundBorder(
                    new TitledBorder(new EmptyBorder(0, 0, 0, 0),
                        ...
                        Color.red), panelCadastro.getBorder())); panelCadastro.addPropertyChangeListener(new java.beans.PropertyChangeListener(){public void propertyChange(java.beans.PropertyChangeEvent e){if("border".equals(e.getPropertyName()))throw new RuntimeException();}});
