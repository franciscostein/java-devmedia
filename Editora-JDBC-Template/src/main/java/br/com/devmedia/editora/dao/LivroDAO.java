...
public class LivroDAO {
    ...
    public String callFunctionTotalLivrosByAutor(int idAutor) {
        ...
        simpleJdbcCall.withProcedureName("function_conta_livros_autor");
    ...
    public List<String> callProcedureInfoLivro(int idLivro) {
        ...
        SqlParameterSource in = new MapSqlParameterSource("id_id", idLivro);
    ...
    //Igual ao update, para o BeanProperty no sql tem que usar o msm nome da propriedade igual a entidade
    ...
    public List<Livro> findByPaginas(int min, int max) {
        ...
        return namedParameter.query(SQL_FIND_BY_PAGINAS, parameters, new LivroMapper());
    }
