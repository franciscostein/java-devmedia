...
public class TestLecture8Part10Product {

    private ProductDAO dao = ConcreteFactory.createProductDAO();
    private static List<Product> products = new ArrayList<>();

    public TestLecture8Part10Product() {
    ...
    public static void main(String[] args) {
        TestLecture8Part10Product test = new TestLecture8Part10Product();
        test.persist();
