package Lectures.lecture8.part12;

import Lectures.lecture8.part12.entity.Product;
import Lectures.lecture8.part12.integration.Factory;
import Lectures.lecture8.part12.integration.JpaFactory;
import Lectures.lecture8.part12.integration.ProductDAO;

import java.util.ArrayList;
import java.util.List;

public class TestLecture8Part12Product {

    private Factory factory = new JpaFactory();
    private ProductDAO dao = factory.createProductDAO();
    private static List<Product> products = new ArrayList<>();

    public TestLecture8Part12Product() {
    ...
    public static void main(String[] args) {
        TestLecture8Part12Product test = new TestLecture8Part12Product();
        test.persist();
