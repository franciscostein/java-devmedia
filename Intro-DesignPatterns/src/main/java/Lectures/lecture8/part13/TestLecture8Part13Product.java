package Lectures.lecture8.part13;

import Lectures.lecture8.part13.entity.Product;
import Lectures.lecture8.part13.integration.Factory;
import Lectures.lecture8.part13.integration.JpaFactory;
import Lectures.lecture8.part13.integration.ProductDAO;

import java.util.ArrayList;
import java.util.List;

public class TestLecture8Part13Product {

    private Factory factory = new JpaFactory();
    private ProductDAO dao = factory.createProductDAO();
    private static List<Product> products = new ArrayList<>();

    public TestLecture8Part13Product() {
    ...
    public static void main(String[] args) {
        TestLecture8Part13Product test = new TestLecture8Part13Product();
        test.persist();
