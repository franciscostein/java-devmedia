...
public class CustomerDaoJDBC implements CustomerDAO {
    ...
    public List<Customer> findAll(String name) {
        ...
        final String query = "select CR.ID, CR.NAME, CR.CITY, CR.CREDENTIAL_ID, CR.ID, " +
                "CL.LOGIN, CL.PASSWORD from CUSTOMER CR, CREDENTIAL CL where CR.NAME like ? AND CR.CREDENTIAL_ID = CREDENTIAL_ID";
        try {
