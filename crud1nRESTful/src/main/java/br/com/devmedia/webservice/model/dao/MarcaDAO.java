...
public class MarcaDAO {
    ...
    public List<Marca> getAll() {
        ...
        try {
            marcas = em.createQuery("select m from Marca m",
    ...
    public Marca getById(long id) {
        ...
        if (marca == null) {
            throw new DAOException("Marca de id " + id +
                    " não existe.", ErrorCode.NOT_FOUND.getCode());
        }
    ...
    public Marca update(Marca marca) {
        ...
        try {
            ...
            em.getTransaction().rollback();
            throw new DAOException("Erro ao atualizar marca no banco de dados: " + ex.getMessage(),
            ErrorCode.SERVER_ERROR.getCode());
        } finally {
            em.close();
        }
